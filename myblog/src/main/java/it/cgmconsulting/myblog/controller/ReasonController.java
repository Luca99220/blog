...
public class ReasonController {
    ...
    public ResponseEntity<?> addReason(@RequestParam @NotBlank @Size(max = 30, min = 5) String reason,
    ...
    @PreAuthorize("hasAuthority('ADMIN')")
    public ResponseEntity<?> deleteReason(@RequestParam @NotBlank @Size(max = 30, min = 5) String reason) {
