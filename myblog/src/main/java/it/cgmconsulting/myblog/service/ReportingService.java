...
public class ReportingService {
    ...
    public List<ReportingResponse> getReports(int pageNumber, int pageSie, String sortBy, String direction, ReportingStatus status){
        Pageable pageable = PageRequest.of(pageNumber, pageSie, Sort.Direction.valueOf(direction.toUpperCase()), sortBy);
