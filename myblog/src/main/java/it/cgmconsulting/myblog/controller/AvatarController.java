...
public class AvatarController {
    ...
    public ResponseEntity<?>addAvatar(
        ...
        return new ResponseEntity<>("Something went wrong during the upload", HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<?> deleteAvatar(@AuthenticationPrincipal UserDetails userDetails){
        ...
        return new ResponseEntity<>("Your avatar has been deleted", HttpStatus.OK);
    }
}
